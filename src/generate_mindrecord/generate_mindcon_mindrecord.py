...
def parse_args():
    ...
    parser.add_argument("--data_dir", type=str, default="/home/shark803/mindspore_projs/mind_con/mindcon_text_classification",
    ...
    parser.add_argument("--vocab_file", type=str, default="/home/shark803/mindspore_projs/mind_con/vocab.txt",
                        help="The vocabulary file that the BERT model was trained on.")
    parser.add_argument("--output_dir", type=str, default="/home/shark803/mindspore_projs/mind_con/output",
